...
class WitsGradDesc:
	def __init__(self, env, actor_c1, actor_c2, noise=True):
		...
		self.actor_c1_optim = torch.optim.SGD(self.actor_c1.parameters(), lr=self.lr, momentum=0.8, nesterov=True)
		self.actor_c2_optim = torch.optim.SGD(self.actor_c1.parameters(), lr=self.lr, momentum=0.8, nesterov=True)
